...
export const PASSWORD_NOT_VALID = 'Current password are not valid';
export const PASSWORD_TO_SHORT = "Password is too short (minimum is 8 characters)";
export const NAMESPACE_NOT_EMPTY = "App have any services";
...
export const IP_FORMAT_INVALID = "IP format incorrect";
...
export const CHOOSE_REPO = "You must choose repository";
export const CHOOSE_TEMPLATE = "You must choose template";
export const CHOOSE_TAG = "You must choose tag";
